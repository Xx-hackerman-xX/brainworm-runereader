...
/*
  ...
  - make it work with selftext
    ...
    - despite hiding the text publicly, posts in above obj contain "body" key which has full post text
    - could maybe poll when a post is finalised and no longer editing, then push entire body contents into html?
      - would need to parse commands to create the right css i guess which would be a hassle
      - otherwise reveal the post's literal contents in a little window beside it or something
        - "show literal" could be doable on every post
...
var config_path = "util/cipher"  // this contains the rune scrambler
try {
...
var convert_to_random_string = "convertToRandomString"
